...
const double GM           = double(3986012) / 1e1;     // Earth gravitational constant, km^3/sec^2
const double GEOSYNC_ALT  = double(42241892) / 1e3;    // km
const double EARTH_DIA    = double(127420176) / 1e4;   //12800.0;      // km
const double DAY_SIDERAL  = (23 * 3600) + (56 * 60) + double(409) / 1e2;  // sec
const double DAY_24HR     = (24 * 3600);   // sec

const double AE           = 1.0;
const double AU           = double(149597870691) / 1e3; //149597870.0;  // Astronomical unit (km) (IAU 76)
const double SR           = 696000.0;     // Solar radius (km)      (IAU 76)
const double XKMPER_WGS72 = double(6378137) / 1e3; //6378.135;            // Earth equatorial radius - km (WGS '72)
const double F            = (double(63781370) - 63567523) / 63781370; //1.0 / 298.26; // Earth flattening (WGS '72)
const double GE           = double(3986008) / 1e1;      // Earth gravitational constant (WGS '72)
const double J2           = double(10826158) / 1e10;    // J2 harmonic (WGS '72)
const double J3           = double(-253881) / 1e11;     // J3 harmonic (WGS '72)
const double J4           = double(-165597) / 1e11;     // J4 harmonic (WGS '72)
...
const double OMEGA_E      = double(100273790934) / 1e11; // earth rotation per sideral day
