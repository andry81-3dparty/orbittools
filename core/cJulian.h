...
//
const double EPOCH_JAN0_12H_1900 = double(24150200) / 1e1; // Dec 31.5 1899 = Dec 31 1899 12h UTC
const double EPOCH_JAN1_00H_1900 = double(24150205) / 1e1; // Jan  1.0 1900 = Jan  1 1900 00h UTC
const double EPOCH_JAN1_12H_2000 = double(24515450) / 1e1; // Jan  1.5 2000 = Jan  1 2000 12h UTC
...
public:
   ...
   time_t ToTime(double * second_fract_ptr = 0) const;           // To time_t type - avoid using
